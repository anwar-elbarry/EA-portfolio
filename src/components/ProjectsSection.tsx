...
const projects: Project[] = [
  ...
  {
    title: "FUTURE CODERS",
    description: "This project is a front-end e-commerce site for the sale of technology products such as laptops, mice, keyboards and headsets. The site allows users to easily navigate between different product categories or view product details.",
    tags: [ "html","javascript","tailwind","css"],
    image : "./images/futurCoders.png",
